...
urlpatterns = [
    ...
    url(r'^u/(?P<owner_name>[^/]*)/sources/tributary/mastodon/auth_gateway/(?P<timeline_name>.+)$', user_tributary_mastodon_auth_gateway, name='user_tributary_mastodon_auth_gateway'),
