...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('wom_user_userprofile_sources', ['userprofile_id', 'source_id'])

        # Adding M2M table for field feed_sources on 'UserProfile'
        db.create_table('wom_user_userprofile_feed_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['wom_user.userprofile'], null=False)),
            ('feedsource', models.ForeignKey(orm['wom_river.feedsource'], null=False))
        ))
        db.create_unique('wom_user_userprofile_feed_sources', ['userprofile_id', 'feedsource_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field feed_sources on 'UserProfile'
        db.delete_table('wom_user_userprofile_feed_sources')
