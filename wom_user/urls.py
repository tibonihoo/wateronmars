...
urlpatterns = patterns('',
                       ...
                       url(r'^(?P<owner_name>[^/]*)/sources/$', 'wom_user.views.user_river_sources'),
                       ...
                       url(r'^(?P<owner_name>[^/]*)/river/$', 'wom_user.views.user_river_view'),
                       url(r'^(?P<owner_name>[^/]*)/sieve/$', 'wom_user.views.user_river_sieve'),
