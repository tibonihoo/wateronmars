...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field generated_feeds on 'UserProfile'
        db.create_table('wom_user_userprofile_generated_feeds', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['wom_user.userprofile'], null=False)),
            ('generatedfeed', models.ForeignKey(orm['wom_tributary.generatedfeed'], null=False))
        ))
        db.create_unique('wom_user_userprofile_generated_feeds', ['userprofile_id', 'generatedfeed_id'])


    def backwards(self, orm):
        # Removing M2M table for field generated_feeds on 'UserProfile'
        db.delete_table('wom_user_userprofile_generated_feeds')
